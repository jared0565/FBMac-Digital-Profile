...
export const projects: Project[] = [
  ...
  },
  {
    ...
    github: null,
    tagline: "Website Upgrade Proposal — Family Cafe & Soft Play",
    description:
      "A proactive redesign proposal for a Barnet family cafe that recently received a 5-star Food Hygiene Rating. The existing site was outdated — this upgrade modernises their web presence with a clean, mobile-first design, clear booking flows, and the new hygiene certificate front and centre.",
    icon: Star,
    tags: ["Website Upgrade", "Local Business", "Client Proposal", "Responsive"],
    metrics: ["5-Star Hygiene", "Proposal Ready"],
    color: "#4ade80",
